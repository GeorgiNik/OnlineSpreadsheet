namespace OnlineSpreadsheet.Web.Application
{
    ...
    public class BundleConfig
    {
        ...
        private static void Custom(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/dataFilesUpload").Include(
                                                                              "~/Scripts/Custom/Data/dataFilesUpload.js"));
            bundles.Add(new ScriptBundle("~/bundles/dataFilesError").Include(
                                                                             "~/Scripts/Custom/Data/dataFilesError.js"));
        }
